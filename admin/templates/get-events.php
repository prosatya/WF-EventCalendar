...
// Accumulate an output array of event data arrays.
		...
		while ( $loop->have_posts() ) : $loop->the_post();
		  ...
		  $color = get_post_meta( $id, 'bp_calender_color_piker', true );
			  $input_arrays[] = array("title"=>get_the_title(), "start"=>$start, "end"=>$end, "url"=>$url, "constraint" => "businessHours", "color" => $color );
		endwhile;
