 ...
 * @subpackage WF-Event Calendar/admin
 */
...
class Wf_event_Admin {
	 ...
	 *
	 * @since    1.0.0
	 * @param      string    $wf_event       The name of this plugin.
	...
	public function enqueue_styles() {
		...
		wp_enqueue_style( $this->wf_event, plugin_dir_url( __FILE__ ) . 'css/wf_event-admin.css', array(), $this->version, 'all' );	
	}
	...
	public function enqueue_scripts() {
		 ...
		 * class.
		 */
		wp_enqueue_script( $this->wf_event, plugin_dir_url( __FILE__ ) . 'js/wf_event-admin.js', array( 'jquery' ), $this->version, false );
	}
	...
	public function plugin_init()
	{
		...
		/* TODO: Register our stylesheet. */
   		// wp_register_style( 'wf_event-style', plugins_url('fullcalendar.css', __FILE__) );
   		// wp_register_style( 'wf_event-style-print', plugins_url('fullcalendar.print.css', __FILE__) );
	   // TODO:Something here
	...
	*/     
	...
	{
	add_options_page('wf_event Plugin Settings', 'wf_event Plugin', 'manage_options', 'wf_event_Plugin', array(&$this, 'plugin_settings_page'));
	...
	*/     
	...
	function wf_event_register_required_plugins() {
		/*
	...
	function wf_event_register_meta_boxes( $meta_boxes )
	{
	    $prefix = 'bp_calender_';
	    // 1st meta box
	    $meta_boxes[] = array(
